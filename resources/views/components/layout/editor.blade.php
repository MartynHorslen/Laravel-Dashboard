            ...
            <div class="card">
                <div class="card-body d-flex flex-col justify-content-center">
                    ...
                    <form class="col-8" method="POST" action="/employees/{{ $data->id }}" enctype="multipart/form-data">
                        ...
                        <input id="company" name="company" class="w-100" type="text" value="{{ $data->company }}"/>

                        <label for="email">Email:</label>
                        <input id="email" name="email" class="w-100" type="text" value="{{ $data->email }}"/>

                        <label for="phone_number">Email:</label>
                        <input id="phone_number" name="phone_number" class="w-100" type="text" value="{{ $data->phone_number }}"/>
